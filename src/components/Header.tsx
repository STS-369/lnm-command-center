    ...
    <header className="h-14 border-b border-border bg-bg-secondary/80 backdrop-blur-sm flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30">
      ...
      <div className="hidden md:flex items-center flex-1 max-w-md">
        <div className="relative w-full">
          ...
          <input
            ...
            aria-label="Search leads, deals, and tasks"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="relative btn-ghost p-2" aria-label="Notifications">
          ...
          <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-neon-red rounded-full" aria-hidden="true"></span>
        </button>

        {/* User avatar */}
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-cyan to-purple flex items-center justify-center text-xs font-bold text-black" aria-hidden="true">
            A
          </div>
